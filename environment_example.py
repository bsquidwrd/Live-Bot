...
os.environ['LIVE_BOT_BASE_DIR'] = os.path.dirname(os.path.abspath(__file__)) # The base directory everything is stored
os.environ['LIVE_BOT_TWITCH_CLIENT_ID'] = "" # The application key from Twitch.tv
os.environ['LIVE_BOT_TWITTER_CONSUMER_KEY'] = "" # Twitter Consumer Key
os.environ['LIVE_BOT_TWITTER_CONSUMER_SECRET'] = "" # Twitter Consumer Secret
os.environ['LIVE_BOT_TWITTER_ACCESS_TOKEN'] = "" # Twitter Access Token
os.environ['LIVE_BOT_TWITTER_ACCESS_TOKEN_SECRET'] = "" # Twitter Access Secret
os.environ['LIVE_BOT_DJANGO_SECRET'] = "" # Django secret for the database
